 ...
 *  and let the fun begin. Shout out to marty spellerberg's awesome Google Maps
 *  tutorial.
 *
*/
//<![CDATA[
...
function initialize() {
	...
	var map = new google.maps.Map(document.getElementById('map'), mapOptions);
	  ...
	  boxtext.innerHTML = "<b>Garden:   </b>" + gardenname + "<br/>" + "<b>Square Footage:  </b>" + squarefootage + "<br/>" + "<b>Description:  </b>" + description;
          infobox_options = {
                        content: boxtext 
...
/*function bindInfoBox(marker, map, infobox, point) {
