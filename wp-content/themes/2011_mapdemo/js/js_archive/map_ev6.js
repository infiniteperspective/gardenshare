...
/*		var contentString =
			'<div id="content">'+'<h1 id="firstHeading" class="firstHeading">Garden Window</h1>'+
			'<div id="bodyContent">'+'<h2><b>Garden:  </b>'+garden_array[0]+'</h2>'+'<h2><b>Fruit or Veggie:  </b>'+garden_array[4]+'</h2>'+'<h2><b>Planting Date:  </b>'+garden_array[5]+'</h2>'+'<h2><b>Quantity:  </b>'+garden_array[6]+'</h2>'+'</div>';
