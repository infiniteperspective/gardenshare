...
var gardens = [['Garden A', 32.725500, -117.252700,'This is content for Garden A'],['Garden B', 32.725550, -117.252750,'This is content for Garden B']]; //declaring an array of static garden locations
...
function setMarkers(map, gardens){
	for (var i = 0; i < gardens.length; i++) {
		...
		var contentString = garden_array[3]; 
