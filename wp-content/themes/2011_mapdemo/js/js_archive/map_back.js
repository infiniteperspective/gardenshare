 ...
 *  tutorial.
 *
 *  "url('/wordpress/wp-content/themes/2011_mapdemo/images/tipbox.gif') no-repeat"
 *
*/
...
function initialize() {
	...
	var boxText = document.createElement("div");
        ...
        boxText.style.cssText = "border: 1px solid black; background: #ADD633; color: #003300; margin-top: 8px; font-family: Arial; font-size:12px; padding: 5px; border-radius: 6px; -webkit-border-radius: 6px; -moz-border-radius: 6px;";
