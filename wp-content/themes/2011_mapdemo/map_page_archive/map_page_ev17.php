...
<div id="primary">
	...
	<div id="garden_dialog" class="add_garden_class" title="Add Garden">
    		...
    		<form method="post" name="add_garden_form" action="addgarden.php">
    		<div class="element">
        		<label>Street Address</label>
        		<input type="text" id="street_address" name="street_address" class="gardentext" value="" />
    		</div>
    		<div class="element">
        		<label>Apt/Suite</label>
        		<input type="text" id="apartment" name="apartment" class="gardentext" value="" />
    		</div>
    		<div class="element">
        		<label>City</label>
        		<input type="text" id="city" name="city" class="gardentext" value="San Diego" readonly=true />
    		</div>
                <div class="element">
                        <label>State</label>
                        <input type="text" id="state" name="state" class="gardentext" value="CA" readonly=true />
                </div>
                <div class="element">
                        <label>Zip Code</label>
                        <input type="number" id="zip_code" name="zip_code" class="gardentext" value="92107" readonly=true />
                </div>
                <div class="element">
                        <label>Square Footage</label>
			<select id="square_footage" class="gardentext" value=""></select>
                </div>
                <div class="element">
                        <label>Description</label>
                        <textarea id="description" name="description" class="gardentext" value=""></textarea>
                </div>
	...
	<script>
	//this code defines the input form fields as variables
          var address = $("input[id=street_address]");
          var apartment = $("input[id=apartment]");
	...
	$("#add_garden").click(function () {
	  ...
	  if (address.val()=="") {
            ...
            return false;
          } else console.log("address entered");
          if (apartment.val()=="") {
            console.log("apartment not entered");
            return false;
          } else console.log("apartment entered");
          if (city.val()=="") {
            console.log("city not entered");
            return false;
          } else console.log("city entered");
          if (state.val()=="") {
            console.log("state not entered");
            return false;
          } else console.log("state entered");
          if (zipcode.val()=="") {
            console.log("zipcode not entered");
            return false;
          } else console.log("zipcode entered");
          if (squarefootage.val()=="") {
            console.log("squarefootage not entered");
            return false;
          } else console.log("squarefootage entered");
          if (gardendescription.val()=="") {
            console.log("gardendescription not entered");
            return false;
          } else console.log("gardendescription entered");
	  ...
	  console.log(address.val());
          ...
          console.log(squarefootage.val());
          console.log(gardendescription.val());
	  */
	  
	  //serializing the data for post
	  var gardendata = address.val() + apartment.val() + city.val() + state.val() + zipcode.val() + squarefootage.val() + gardendescription.val();
	...
	<!-- Add_Food_Exchange_Form --> 
        <div id="food_exchange_dialog" class="dialog" title="Add Food Exchange">
            <div class="form">
                <form method="post" name="add_food_exchange_form" action="addfoodexchange.php">
                <div class="element">
                        <label>Plant for Exchange</label>
                        <input type="text" id="plant_for_exchange" name="plant_for_exchange" class="foodtext" value="" />
                </div>
                <div class="element">
                        <label>Quantity for Exchange</label>
                        <select id="exchange_quantity" name="exchange_quantity" class="foodtext" value="" ></select>
		</div>
                <div class="element">
                        <label>Avail Date</label>
                        <input id="datepicker" name="date_of_availability" class="foodtext" value="" />
                </div>
                <div class="element">
                        <label>Desired Exchange</label>
                        <input id="desired_exchange" type="text" name="desired_exchange" class="foodtext" value="" />
                </div>
                <div class="button_element">
	...
	<!-- Add_Work_Exchange_Form --> 
        <div id="work_exchange_dialog" class="dialog" title="Add Work Exchange">
            <div class="form">
                <form method="post" name="add_work_exchange_form" action="addworkexchange.php">
                <div class="element">
                        <label>First Name</label>
                        <input type="text" id="first_name" name="first_name" class="worktext" value="" />
                </div>
                <div class="element">
                        <label>Email</label>
                        <input type="text" id="email" name="email" class="worktext" value="" />
                </div>
                <div class="element">
                        <label>Years of Experience</label>
                        <select id="experience" class="worktext" value=""></select>
                </div>
                <div class="element">
                        <label>Available Hrs per Week</label>
                        <select id="available_hours" class="worktext" value=""></select>
                </div>
                <div class="element">
                        <label>Describe Expertise</label>
                        <textarea id="expertise" name="expertise" class="worktext" value=""/></textarea>
                </div>
                <div class="button_element">
