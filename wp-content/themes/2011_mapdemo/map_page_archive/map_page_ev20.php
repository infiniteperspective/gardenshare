        ...
        <div id="food_exchange_dialog" class="dialog" title="Add Food Exchange">
            <div class="food_exchange_form_container">
                ...
                <div class="element">
                        ...
                        <input id="foodexchangedate" name="date_of_availability" class="required" value="" />
                </div>
                <div class="element">
	...
	<!-- Add_Work_Exchange_Form --> 
        <div id="work_exchange_dialog" class="dialog" title="Add Work Exchange">
            <div class="work_exchange_form_container">
                ...
                <div class="element">
                        <label>Avail Date</label>
                        <input id="workexchangedate" name="date_of_availability" class="required" value="" />
                </div>
		<div class="element">
	...
	*/  
	...
	<!-- Remove_Food_Exchange_Form --> 
        <div id="remove_food_exchange_dialog" class="dialog" title="Remove Food Exchange">
			...
			<option><?php echo $current_user->user_login ?></option>
			<option><?php echo $current_user->ID ?></option>
			<option><?php echo $current_user->user_nicename ?></option>
			</select>
                </div>
                <div class="button_element">
...
//Accessing resultset array
        while ($row = $result->fetch_array(MYSQLI_NUM)){
                printf ("First Name: %s, Experience(yrs): %s, Availability (Hrs/wk): %s, Email: %s, Expertise: %s\n", $row[0], $row[1], $row[2], $row[3], $row[4]);}
echo "</textarea>\n";
echo    "</form>\n";
echo "</div>\n";
