...
<div id="primary">
	...
	<div id="garden_dialog" class="add_garden_class" title="Add Garden">
    		...
    		<form method="post" name="add_garden_form">
    		<div class="element">
	...
	<!-- Add_Food_Exchange_Form --> 
        <div id="food_exchange_dialog" class="dialog" title="Add Food Exchange">
            <div class="form">
                <form method="post" name="add_food_exchange_form">
                <div class="element">
                        <label>Plant for Exchange</label>
                        <input type="text" id="plant_for_exchange" name="plant_for_exchange" class="text" />
                </div>
                <div class="element">
                        <label>Quantity for Exchange</label>
                        <select id="exchange_quantity" name="exchange_quantity" class="text"></select>
		</div>
                <div class="element">
                ...
                <div class="element">
                        ...
                        <input id="desired_exchange" type="text" name="desired_exchange" class="text" />
                </div>
                <div class="button_element">
	...
	<!-- Add_Work_Exchange_Form --> 
        <div id="work_exchange_dialog" class="dialog" title="Add Work Exchange">
            <div class="form">
                <form method="post" name="add_work_exchange_form">
                <div class="element">
                ...
                <div class="element">
                        ...
                        <textarea id="expertise" name="expertise" class="text textarea" /></textarea>
                </div>
                <div class="button_element">
