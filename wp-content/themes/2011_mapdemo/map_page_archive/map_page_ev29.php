...
<div id="primary">
	...
	$("#add_garden").click(function (event) {
	  ...
	  var geocode_address = address.val() + "  " + city.val() + "  " +  state.val();
	  //console.log(geocode_address);
	  //var latitude = 32.725000;
	  //var longitude = -117.257000;
	  //serializing the data for post
          var gardendata = 'userid=' + userid + '&gardenname=' + gardenname.val() + '&address=' + address.val() + '&city=' + city.val() + '&state=' + state.val() + '&zipcode=' + zipcode.val() + '&squarefootage=' + squarefootage.val() + '&gardendescription=' + gardendescription.val() + '&latitude=' + latitude + '&longitude=' + longitude;
