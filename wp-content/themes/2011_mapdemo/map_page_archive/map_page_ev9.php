...
<script>
    $(function() {
        ...
        $( "#remove_garden" ).click(function() {
            $( "#dialog" ).dialog( "open" );
            return false;
        });
        $( "#remove_food_exchange" ).click(function() {
            $( "#dialog" ).dialog( "open" );
            return false;
        });
        $( "#remove_work_exchange" ).click(function() {
            $( "#dialog" ).dialog( "open" );
            return false;
        });
...
<div id="primary">
	...
	<!-- Add_Food_Exchange_Form --> 
        <div id="food_exchange_dialog" class="dialog" title="Add Garden">
            <div class="form">
                <form method="post" action="process.php">
                <div class="element">
                        <label>Name</label>
	...
	<!-- Add_Work_Exchange_Form --> 
        <div id="work_exchange_dialog" class="dialog" title="Add Garden">
            <div class="form">
                <form method="post" action="process.php">
                <div class="element">
                        <label>Name</label>
	...
	<div class="width_divider"></div>
        <button id="add_garden" class="garden_button" >Add A Garden</button>
	<button id="add_food_exchange" class="garden_button" >Add Food Exchange</button>
	<button id="add_work_exchange" class="garden_button" >Add Work Exchange</button>
	<br>
	<div class="width_divider"></div>
	<button id="remove_garden" class="garden_button" >Remove Garden</button>
	<button id="remove_food_exchange" class="garden_button" >Remove Food Exchange</button>
	<button id="remove_work_exchange" class="garden_button" >Remove Work Exchange</button>
	</div>
