...
<div id="primary">
	...
	<div id="garden_dialog" class="add_garden_class" title="Add Garden">
    		...
    		<div class="element">
        		...
        		<input type="text" id="address" name="street_address" class="text" />
    		</div>
    		<div class="element">
        	...
        	<input type="button" id="add_garden" class="garden_button" value="Add Garden" />
	...
	var consoleTest = function() {
  	console.log( 'a garden was added' );
	};
	var gardenClose = function() {
        $( "#garden_dialog" ).dialog( "close" );
	};
	$('#add_garden').on( 'click', consoleTest );
	$('#add_garden').on( 'click', gardenClose );  
	</script>
...
if (is_user_logged_in()){
	...
	echo'<div class="width_divider"></div>';
        echo'<button id="add_garden_button" class="garden_button" >Add A Garden</button>';
