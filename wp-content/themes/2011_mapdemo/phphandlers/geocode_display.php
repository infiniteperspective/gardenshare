...
//Build the SQL query
$query = "SELECT garden_name, square_footage, description, latitude, longitude FROM gardens";
...
while ($row = @mysqli_fetch_assoc($result)){
  ...
  $newnode->setAttribute("gardenname", $row['garden_name']);
  $newnode->setAttribute("squarefootage", $row['square_footage']);
