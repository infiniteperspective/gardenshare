<?php
//The purpose of this file is to query the current food and work exchanges and present them in textareas 
//Database Connection for MySQL v 5.5 Wordpress DB
$dbhost = "localhost";
