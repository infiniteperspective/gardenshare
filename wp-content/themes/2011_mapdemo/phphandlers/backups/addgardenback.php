...
//Build the SQL query
$query = "INSERT INTO gardens (userid, garden_name, street_address, city, state, zipcode, square_footage, description) values ($userid,'$gardenname','$address', '$city', '$state', '$zipcode', $squarefootage, '$gardendescription')";
